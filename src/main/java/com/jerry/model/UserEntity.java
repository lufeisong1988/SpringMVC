...
public class UserEntity {
    ...
    private Collection<BlogEntity> bolgsById;
    ...
    public Collection<BlogEntity> getBolgsById() {
        return bolgsById;
    }

    public void setBolgsById(Collection<BlogEntity> bolgsById) {
        this.bolgsById = bolgsById;
    }
}
